            ...
            <div class="table-responsive">
                <table class="table table-striped table-sm">
                    ...
                    <c:forEach items="${products}" var="product">
                        ${product}
                    <c:choose>
                    <c:when test="${product.getStatus()!=ProdStatus.NO_AVAILABLE}">
                        <tr>
                            <td>${product.id}</td>
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${product.getStatus()==ProdStatus.AVAILABLE}">
                                        В наличии
                                    </c:when>
                                    <c:when test="${product.getStatus()==ProdStatus.ON_ORDER}">
                                        Под заказ
                                    </c:when>
                                    <c:otherwise>
                                        Нет данных
